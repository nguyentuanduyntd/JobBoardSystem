...
export default function EmployerPostJob() {
    ...
    useEffect(() => {
        ...
        fetch(`${API_URL}/jobcategories/`)
        .then(r => r.json())
        .then(d => setCategories(Array.isArray(d) ? d : (d.results || [])))

        fetch(`${API_URL}/skills/`)
        .then(r => r.json())
        .then(d => setSkills(Array.isArray(d) ? d : (d.results || [])))
        }, [user])
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await authFetch(`${API_URL}/employer/jobs/`, {
                method: 'POST',
    ...
    if (success) return (
        <div className="container mt-5 text-center">
            ...
            <h4 className="fw-bold text-success mt-3">Đăng tin thành công!</h4>
    ...
    return (
        <div className="container mt-4 mb-5" style={{ maxWidth: 800 }}>
            <div className="d-flex align-items-center gap-3 mb-4">
                ...
                <div>
                    <h4 className="fw-bold mb-0">Đăng tin tuyển dụng</h4>
                    <p className="text-muted mb-0 small">Điền thông tin vị trí cần tuyển</p>
                </div>
            </div>
